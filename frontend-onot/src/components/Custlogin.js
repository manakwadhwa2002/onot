        ...
        <div className="login-card">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="form-group">
              ...
              <label htmlFor="exampleInputEmail1">Email User Id</label>
              <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your user id" onChange={(e) => setEmail(e.target.value)} />
            </div>
